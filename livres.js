...
const livres = {
    litterature: [
        { titre: "Idée d'une Histoire universelle au point de vue cosmopolitique", auteur: "Emmanuel KANT", genre: "Philosophie", edition: "Bordas", isbn: "2-04-018061-3", placement: "C1", langue: "Français", langue_origine: "Allemand", traduit: true, type_edition: "moderne", commentaire: "", couverture: "images/kant.jpg" },
        { titre: "Cinq leçons sur la psychanalyse", auteur: "Sigmund FREUD", genre: "Psychanalyse", edition: "Petit Bibliothéque Payot", isbn: "2-228-30849-8", placement: "C1", langue: "Français", langue_origine: "Allemand", traduit: true, type_edition: "moderne", commentaire: "", couverture: "" },
        ...
        { titre: "L'École des femmes", auteur: "Molière", genre: "Théâtre", edition: "Bordas", isbn: "2-04-016050-7", placement: "C2", langue: "Français", langue_origine: null, traduit: false, type_edition: "moderne", commentaire: "", couverture: "" },
        { titre: "Les Misérables II", auteur: "Victor HUGO", genre: "Littérature FR", edition: "Livre du poche", isbn: "-", placement: "C2", langue: "Français", langue_origine: null, traduit: false, type_edition: "moderne", commentaire: "", couverture: "" },
        { titre: "Le Parfum", auteur: "Patrick Süskind", genre: "Roman", edition: "Le livre de poche", isbn: "-", placement: "C1", langue: "Français", langue_origine: "Allemand", traduit: true, type_edition: "moderne", commentaire: "", couverture: "images/parfum.jpg" },
        { titre: "La ferme des animaux", auteur: "George Orwell", genre: "Allégorie", edition: "Folio", isbn: "978-2-07-037516-5", placement: "C1", langue: "Français", langue_origine: "Anglais", traduit: true, type_edition: "moderne", commentaire: "", couverture: "images/la_ferme_des_animaux.jpg" },
        { titre: "En attendant Godot", auteur: "Samuel Beckett", genre: "Théâtre", edition: "Minuit", isbn: "978-2-7073-0148-2", placement: "C1", langue: "Français", langue_origine: "Français (auteur irlandais)", traduit: false, type_edition: "moderne", commentaire: ".", couverture: "" },
        { titre: "Le mythe de Sisyphe", auteur: "Albert Camus", genre: "Essai", edition: "Folio", isbn: "978-2-07-032288-6", placement: "C1", langue: "Français", langue_origine: null, traduit: false, type_edition: "moderne", commentaire: "", couverture: "" },
        { titre: "Le Cid", auteur: "Pierre Corneille", genre: "Théâtre classique", edition: "GF Flammarion", isbn: "978-2-08-071156-4", placement: "C2", langue: "Français", langue_origine: null, traduit: false, type_edition: "bilingue-ancien-moderne", commentaire: "", couverture: "" },
        ...
        { titre: "L'alphabet des femmes", auteur:"Guéorgui Gospodinov", genre: "Roman", edition: "arléa", isbn: "9782363080615", placement: "S", langue: "Français", langue_origine: "Bulgare", traduit: true, type_edition: "moderne", commentaire: "", couverture: "images/ab-femme.jpg" }
    ],
    asie: [
    ...
    petitprince: [
        ...
        { titre: "Il Piccolo Principe", auteur: "Saint-Exupéry", genre: "Conte", edition: "", isbn: "", placement: "C1", langue: "Italiano", commentaire: "Version italienne du Petit Prince.", couverture: "images/il-piccolo.jpg" } ,
        { titre: "星の王子さま", auteur: "Saint-Exupéry", genre: "Conte", edition: "", isbn: "", placement: "C1", langue: "日本語 / Japonais", commentaire: "Version japonaise du Petit Prince.", couverture: "images/xingkowangzi.jpg" }
    ],
    manga: [
